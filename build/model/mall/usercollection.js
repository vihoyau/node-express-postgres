...
exports.defineFunction = function (sequelize) {
    return sequelize.define(modelName, {
        ...
        CardAmount: sequelize_1.DataTypes.INTEGER,
        CardIdAmounts: sequelize_1.DataTypes.JSONB,
        ChipIdAmounts: sequelize_1.DataTypes.JSONB,
        CollectionPassUserId: sequelize_1.DataTypes.ARRAY(sequelize_1.DataTypes.STRING),
        CollectionGetUserId: sequelize_1.DataTypes.ARRAY(sequelize_1.DataTypes.STRING),
        CollectionState: sequelize_1.DataTypes.INTEGER,
        ChipUserId: sequelize_1.DataTypes.ARRAY(sequelize_1.DataTypes.STRING),
        ByChipUserId: sequelize_1.DataTypes.ARRAY(sequelize_1.DataTypes.STRING),
        createTime: sequelize_1.DataTypes.TIME,
        UserCollection: sequelize_1.DataTypes.ARRAY(sequelize_1.DataTypes.STRING),
        rewardtimestamp: sequelize_1.DataTypes.TIME,
    }, {
        timestamps: false,
        schema: "mall",
...
//�û��μӻ
function addUserCollection(addUserCollections) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            console.log(addUserCollections);
            let res = yield global_1.getModel(modelName).create(addUserCollections, { returning: true });
...
exports.addUserCollection = addUserCollection;
//��ѯ���û��Ƿ�μӹ��û
function selectUserCollection(selectUserCollections) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            console.log(selectUserCollections);
            let res = yield global_1.getModel(modelName).findOne({ where: { Useruuid: selectUserCollections.Useruuid, Activityuuid: selectUserCollections.Activityuuid } });
            return res ? res.get() : undefined;
        }
        catch (e) {
            throw new Error(e);
...
exports.selectUserCollection = selectUserCollection;
//����û�İ�æ��
function insertUserCollection(Activityuuid, Useruuid) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            //��ѯĳ����İ�æ¼�����Ƿ�Ϊ��
            let coll = yield global_1.getModel("mall.collectioncreate").findOne({ where: { uuid: Activityuuid } });
            ...
            let res = yield global_1.getModel("mall.collectioncreate").update({ collectiondone }, { where: { uuid: Activityuuid } });
            return res;
        }
        catch (e) {
            throw new Error(e);
...
exports.insertUserCollection = insertUserCollection;
//添加领奖人数
function insertrewardDone(Activityuuid, rewardDone) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let res = yield global_1.getModel("mall.collectioncreate").update({ rewardDone }, { where: { uuid: Activityuuid } });
            return res;
        }
        catch (e) {
            throw new Error(e);
...
exports.insertrewardDone = insertrewardDone;
//��ѯ���û��Ƿ�����ϼ��ռ�����Ƭ
function selectUserCollectionChips(selectUserCollections) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            console.log(selectUserCollections);
            let res = yield global_1.getModel(modelName).findOne({ where: { uuid: selectUserCollections.Useruuid, Activityuuid: selectUserCollections.Activityuuid } });
            return res ? res.get() : undefined;
        }
        catch (e) {
            throw new Error(e);
...
exports.selectUserCollectionChips = selectUserCollectionChips;
//��ѯ���û��Ƿ�����ռ����ÿ���
function selectUserCollectionCard(selectUserCollectionCards) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            console.log(selectUserCollectionCards);
            let res = yield global_1.getModel(modelName).findOne({ where: { Useruuid: selectUserCollectionCards.UserId, Activityuuid: selectUserCollectionCards.Activityuuid } });
            return res ? res.get() : undefined;
        }
        catch (e) {
            throw new Error(e);
...
exports.selectUserCollectionCard = selectUserCollectionCard;
//�μӻ���û��Կ��ƽ����ռ�
function UserCollectionCard(UserCollectionCards) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            console.log(UserCollectionCards);
            let CollectionState = UserCollectionCards.CollectionState;
            let CardAmount = 1;
            let rs = yield global_1.getModel("mall.collectioncreate").findOne({ where: { uuid: UserCollectionCards.Activityuuid } });
            ...
            yield global_1.getModel(modelName).update({ CardIdAmounts: CardIdAmounts, ChipIdAmounts, CardAmount: CardAmount, CollectionState: CollectionState }, { where: { Useruuid: UserCollectionCards.Useruuid, Activityuuid: UserCollectionCards.Activityuuid } });
            let res = yield global_1.getModel(modelName).findOne({ where: { Useruuid: UserCollectionCards.Useruuid, Activityuuid: UserCollectionCards.Activityuuid } });
            return res;
        }
        catch (e) {
            console.log(1111111);
...
exports.UserCollectionCard = UserCollectionCard;
//��ѯ���û��Ƿ��ڸû�ռ�������
function UserCollectedCard(UserCollectedCards) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            console.log(UserCollectedCards);
            let res = yield global_1.getModel(modelName).findOne({ where: { uuid: UserCollectedCards.Useruuid, Activityuuid: UserCollectedCards.Activityuuid } });
...
exports.UserCollectedCard = UserCollectedCard;
//�����ղؿ���
function UserCollectionCardHelp(UserCollectionCards) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            console.log(UserCollectionCards);
            let rs = yield global_1.getModel("mall.collectioncreate").findOne({ where: { uuid: UserCollectionCards.Activityuuid } });
            ...
            let CardProbability = rs.CardProbability;
            //��ѯ��������Ϣ
            let Col = yield global_1.getModel(modelName)
            ...
            let userinfo = yield global_1.getModel("users.users").findOne({ where: { uuid: UserCollectionCards.Useruuid } });
            //�ռ���¼
            let timehelp = new Date().getTime();
            let headurl = userinfo.headurl;
            let username = userinfo.nickname;
            let whichCollectioncard = whichCollectionCard;
            ...
            if (!CollectionGetUserId) {
                ...
                yield global_1.getModel(modelName).update({ CardIdAmounts, CardAmount, CollectionGetUserId, UserCollection: UserCollectionss }, { where: { Useruuid: UserCollectionCards.UserId, Activityuuid: UserCollectionCards.Activityuuid } });
            }
            else {
                //�ж��Ƿ�������ռ��
                if (rs.CardIdAmounts === 5 && CardIdAmounts.card1 >= 1
                    ...
                    yield global_1.getModel(modelName).update({ CollectionState: 2 }, { where: { Useruuid: UserCollectionCards.UserId, Activityuuid: UserCollectionCards.Activityuuid } });
                }
                ...
                yield global_1.getModel(modelName)
                    .update({ CardIdAmounts: CardIdAmounts, CardAmount: CardAmount, CollectionGetUserId: CollectionGetUserId, UserCollection: UserCollection }, { where: { Useruuid: UserCollectionCards.UserId, Activityuuid: UserCollectionCards.Activityuuid } });
            }
            //��԰�æ��¼��
            let HCol = yield global_1.getModel(modelName)
            ...
            if (!CollectionPassUserId) {
                ...
                yield global_1.getModel(modelName)
                    .update({ CollectionPassUserId }, { where: { Useruuid: UserCollectionCards.Useruuid, Activityuuid: UserCollectionCards.Activityuuid } });
            }
            else {
...
exports.UserCollectionCardHelp = UserCollectionCardHelp;
//�ռ���Ƭ
function UserCollectionchipHelp(UserCollectionchipHelps) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (CollectionGetUserId) {
                ...
                CollectionGetUserId.forEach((PassUserId) => __awaiter(this, void 0, void 0, function* () {
                    let Coll = yield global_1.getModel(modelName)
                    ...
                    if (Coll) {
                        ...
                        let rs = yield global_1.getModel("mall.collectioncreate").findOne({ where: { uuid: UserCollectionchipHelps.Activityuuid } });
                        ...
                        let userinfo = yield global_1.getModel("users.users").findOne({ where: { uuid: UserCollectionchipHelps.Useruuid } });
                        let timehelp = new Date().getTime();
                        let headurl = userinfo.headurl;
                        let username = userinfo.nickname;
                        ...
                        //�����ռ���Ƭ���������û�id
                        let res = yield global_1.getModel(modelName).update({ CardIdAmounts, ChipIdAmounts, UserCollection: UserCollection, CardAmount }, { where: { Useruuid: PassUserId, Activityuuid: UserCollectionchipHelps.Activityuuid } });
                        //�ж��Ƿ�������ռ��
                        if (chipProbability.length === 5 && CardIdAmounts.card1 >= 1
                            && CardIdAmounts.card2 >= 1 && CardIdAmounts.card3 >= 1
                            && CardIdAmounts.card4 >= 1 && CardIdAmounts.card5 >= 1) {
                            yield global_1.getModel(modelName).update({ CollectionState: 2 }, { where: { Useruuid: PassUserId, Activityuuid: UserCollectionchipHelps.Activityuuid } });
                        }
...
exports.UserCollectionchipHelp = UserCollectionchipHelp;
//�鿴�û������
function find_UserInfo_Activity(Activityuuid, Useruuid) {
    return __awaiter(this, void 0, void 0, function* () {
        let res = yield global_1.getModel(modelName).findOne({ where: { Activityuuid: Activityuuid, Useruuid: Useruuid } });
        // res = res.get()
...
exports.find_UserInfo_Activity = find_UserInfo_Activity;
//�鿴ĳ���
function find_Info_Activity(Activityuuid) {
    return __awaiter(this, void 0, void 0, function* () {
        let res = yield global_1.getModel("mall.collectioncreate").findOne({ where: { uuid: Activityuuid } });
        return res;
    });
}
exports.find_Info_Activity = find_Info_Activity;
//���Ҳ鿴���еĻ
function find_AllUser_Activity() {
    return __awaiter(this, void 0, void 0, function* () {
        let res = yield global_1.getModel(modelName).findAll();
        return res ? res.map(r => r.get()) : undefined;
    });
}
exports.find_AllUser_Activity = find_AllUser_Activity;
//�鿴�û��������
function findUserBirthday(uuid) {
    return __awaiter(this, void 0, void 0, function* () {
        let res = yield global_1.getModel("users.users").findOne({ where: { uuid: uuid } });
        let birthday = res.birthday;
        return birthday;
    });
}
exports.findUserBirthday = findUserBirthday;
//�鿴��������
function findfortune(uuid) {
    return __awaiter(this, void 0, void 0, function* () {
        let res = yield global_1.getModel("mall.collectionaward").findOne({ where: { uuid: uuid } });
        return res;
    });
}
exports.findfortune = findfortune;
//�鿴����
function findisNoFor(Activityuuid) {
    return __awaiter(this, void 0, void 0, function* () {
        let res = yield global_1.getModel("mall.collectioncreate").findOne({ where: { uuid: Activityuuid } });
...
exports.findisNoFor = findisNoFor;
//��ȡ����
function getreward(uuid, Activityuuid, rewardtimestamp) {
    return __awaiter(this, void 0, void 0, function* () {
        yield global_1.getModel(modelName).update({ CollectionState: 3, rewardtimestamp }, { where: { Useruuid: uuid, Activityuuid }, returning: true });
    });
}
...
function find_UserInfoLog(Activityuuid) {
    return __awaiter(this, void 0, void 0, function* () {
        let res = yield global_1.getModel(modelName).findAll({ where: { Activityuuid } });
        return res;
    });
}
exports.find_UserInfoLog = find_UserInfoLog;
function find_User(Useruuid) {
    return __awaiter(this, void 0, void 0, function* () {
        let res = yield global_1.getModel("users.users").findOne({ where: { uuid: Useruuid } });
        return res ? res.get() : undefined;
    });
}
exports.find_User = find_User;
//�û�������uuid
function find_uuid(Useruuid) {
    return __awaiter(this, void 0, void 0, function* () {
        let res = yield global_1.getModel("users.users").findOne({ where: { uuid: Useruuid } });
        return res ? res.get() : undefined;
    });
}
exports.find_uuid = find_uuid;
//��ѯ����
function findColInfo1(obj1, cursor, limit) {
    return __awaiter(this, void 0, void 0, function* () {
        let res = yield global_1.getModel(modelName).findAll({ where: obj1, order: [['createTime', "DESC"]], offset: cursor, limit: limit });
        return res.map(r => r.get());
    });
}
exports.findColInfo1 = findColInfo1;
//�û�����uuid
function findColInfo(username) {
    return __awaiter(this, void 0, void 0, function* () {
        let res = yield global_1.getModel(modelName).findOne({ where: { username } });
        return res ? res.get() : undefined;
    });
}
exports.findColInfo = findColInfo;
//ģ����ѯ
function getCount1(Activityuuid, CollectionState) {
    return __awaiter(this, void 0, void 0, function* () {
        let res = yield global_1.getModel(modelName).findAll({ where: { Activityuuid, CollectionState } });
        return res;
    });
}
