...
exports.defineFunction = function (sequelize) {
    return sequelize.define(modelName, {
        ...
        infouuid: sequelize_1.DataTypes.UUID,
 ...
 * @param infouuid
 */
function insertadsComment(content, useruuid, infouuid) {
    return __awaiter(this, void 0, void 0, function* () {
        let res = global_1.getModel(modelName).create({ content: content, useruuid: useruuid, infouuid: infouuid }, { returning: true });
        return res;
    });
}
 ...
 * @param parent
 */
function insertParentComment(content, useruuid, infouuid, parent) {
    return __awaiter(this, void 0, void 0, function* () {
        let res = yield global_1.getModel(modelName).create({ content: content, useruuid: useruuid, infouuid: infouuid, parent: parent }, { returning: true });
        return res;
    });
}
...
function queryadsCommentNum(sequelize, infouuid) {
    return __awaiter(this, void 0, void 0, function* () {
        let res = yield sequelize.query(`select count(*) from ads.infocomment as comment where comment.infouuid = '${infouuid}' and comment.state not in ('new') and parent is null`, { type: 'select' });
        return res ? res : null;
    });
}
...
function querycommentRepliedCount(sequelize, commentUUID) {
    return __awaiter(this, void 0, void 0, function* () {
        let res = yield sequelize.query(`select count(comment.uuid) as count  from ads.infocomment as comment where parent = '${commentUUID}'`);
        return res ? res : undefined;
    });
}
exports.querycommentRepliedCount = querycommentRepliedCount;
function queryadsCommentUpnumMAX(sequelize, infouuid) {
    return __awaiter(this, void 0, void 0, function* () {
        let res = yield sequelize.query(`select comment.uuid as commentuuid, content, users.nickname,users.headurl ,comment.upnum, comment.created from  ads.infocomment as comment ,users.users as users ,
...
function queryCommentParentDownLastcomment(sequelize, commentuuid) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let res = yield sequelize.query(`select comment.content, users.nickname  from ads.infocomment as comment ,users.users as users
...
function queryCommentParent(sequelize, infouuid) {
    return __awaiter(this, void 0, void 0, function* () {
...
function queryCommentParentDownNum(sequelize, infouuid, commentuuid) {
    return __awaiter(this, void 0, void 0, function* () {
        let res = yield sequelize.query(`select count(*) as count from ads.infocomment as comment ,users.users as users where comment.parent = '${commentuuid}'  and  comment.useruuid = users.uuid and comment.state in ('on') and comment.infouuid = '${infouuid}'`, { type: 'select' });
...
function queryCommentByparentuuid(sequelize, commentuuid) {
    return __awaiter(this, void 0, void 0, function* () {
        let res = yield sequelize.query(`select "comment".uuid as commentuuid, content, users.nickname ,"comment".created,"comment".upnum from ads."infocomment" as comment ,users.users as users where comment.useruuid = users.uuid and parent = '${commentuuid}' and comment.state in ('on') order by created desc`, { type: 'select' });
        return res ? res : null;
    });
}
...
function queryCountcrmcommnet(sequelize, classify, advertiseruuid) {
    return __awaiter(this, void 0, void 0, function* () {
        if (classify == undefined || classify == null || classify == "") {
            if (advertiseruuid != undefined) {
                let res = yield sequelize.query(`select count(comment.uuid) as count from  ads.informationads as ads , users.users as users ,ads.infocomment as comment
...
//# sourceMappingURL=infocomment.js.map