...
//插入一条记录
function insertDaySum(obj) {
    return __awaiter(this, void 0, void 0, function* () {
        let re = yield global_1.getModel(modelName).create(obj);
        return re ? re : undefined;
    });
}
exports.insertDaySum = insertDaySum;
//找这个广告商某天的汇总记录
function findByDateAndUUID(date, advertiseruuid) {
    return __awaiter(this, void 0, void 0, function* () {
        let res = yield global_1.getModel(modelName).findOne({ where: { date, advertiseruuid } });
        return res ? res.get() : undefined;
    });
}
exports.findByDateAndUUID = findByDateAndUUID;
//# sourceMappingURL=daysum.js.map