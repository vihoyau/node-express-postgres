...
// 用户参加活动
exports.router.post('/useractivity', logindao_1.checkAppLogin, function (req, res, next) {
...
//收集卡牌
exports.router.post('/userjoinactivity', logindao_1.checkAppLogin, function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        let { Activityuuid } = req.body;
        try {
            const info = req.loginInfo;
...
//帮我收藏卡牌
exports.router.post('/helpothercollection', logindao_1.checkAppLogin, function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        //UserId是用户发出链接的用户id
...
//查看用户出生年份
exports.router.get('/userbirthday/:Activityuuid', logindao_1.checkAppLogin, function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let Activityuuid = req.params["Activityuuid"];
...
//领取奖励
exports.router.post('/getreward', logindao_1.checkAppLogin, function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (CollectionState !== 2) {
                ...
                let rewardDone = rewardDoneNumber + 1;
...
//查看活动crm记录
exports.router.get('/getrewardinfo/:Activityuuid', logindao_1.checkAppLogin, function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let Activityuuid = req.params["Activityuuid"];
            // let Activityuuid = req.params["Activityuuid"];
...
exports.router.get('/getuserinfo/:Activityuuid/:useruuid', function (req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
